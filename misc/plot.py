...
# Call the function to plots the data
...
x_0 = np.array([0.25]*4)
x_1 = np.array([0, 1, 0, 0])
x_t = 0.5 * (x_0 + x_1)



plt.bar(['1', '2', '3', '4'], x_0, color='red', alpha=.6, label='')
plt.ylim((0, 1))
plt.xticks(fontsize=16)
plt.yticks(fontsize=16)
plt.title('$q_0$', fontsize=20)
plt.show()

plt.bar(['1', '2', '3', '4'], x_1, color='green', alpha=.6, label='')
plt.ylim((0, 1))
plt.xticks(fontsize=16)
plt.yticks(fontsize=16)
plt.title('$p_{data}$', fontsize=20)
plt.show()

plt.bar(['1', '2', '3', '4'], x_t, color='blue', alpha=.6, label='')
plt.ylim((0, 1))
plt.xticks(fontsize=16)
plt.yticks(fontsize=16)
plt.title('$p_t(x|x_1)$', fontsize=20)
plt.show()