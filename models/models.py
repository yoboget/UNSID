...
class DenseGNN(nn.Module):
    def __init__(self, config, nnf_in, nef_in, nnf_out, nef_out, nhf, norm_out=False, global_pooling=False):
        super().__init__()
        ...
        for layer in range(n_layers):
            ...
            attention_layers.append(torch.nn.MultiheadAttention(nhf, 16, batch_first=True, dropout=0.1))
